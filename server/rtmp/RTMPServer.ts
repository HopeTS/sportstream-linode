...
RTMPServer.on('preConnect', (id: any, args: any) => {
    console.log('[NodeEvent on preConnect]', `id=${id} args=${JSON.stringify(args)}`);
});

RTMPServer.on('prePublish', async (id: any, StreamPath: any, args: any) => {
...
RTMPServer.on('donePublish', async (id: any, StreamPath: any, args: any) => {
    console.log('[nms]', `id=${id} StreamPath=${StreamPath} args=${JSON.stringify(args)}`);
