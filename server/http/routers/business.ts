 ...
 */
router.get('/business/get-user-doc', ensureLoggedIn(), 
    async (req: any, res: any) => {
        try {
            // Find Business account
            const business = await Business.findOne(
 ...
 */
router.get('/business/get-connected-users', ensureLoggedIn(), 
    async (req: any, res: any) => {
        try {
            // Find Business account
            const business = await Business.findOne(
 ...
 */
router.get('/business/get-upcoming-streams', ensureLoggedIn(), 
    async (req: any, res: any) => {
        try {
            // Find Business account
            const business = await Business.findOne(
 ...
 * }}
 */
router.post('/business/create-stream', ensureLoggedIn(), 
    async (req: any, res: any) => {
 ...
 * User to Business)
 */
router.post('business/connect-user', ensureLoggedIn(), 
    async (req: any, res: any) => {
